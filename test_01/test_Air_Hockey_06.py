...
def draw_boundaries():
    edge = 50
    pygame.draw.rect(screen, WHITE, (0, 50, window_width, window_height-edge), 10)  # Spielumrandung
    pygame.draw.line(screen, WHITE, [window_width / 2, 50], [window_width / 2, window_height],5)
    pygame.draw.line(screen, WHITE, [window_width / 2-100, 50], [window_width / 2-100, window_height],5)
    pygame.draw.line(screen, WHITE, [window_width / 2+100, 50], [window_width / 2+100, window_height],5)
...
while running:
    ...
    for i, joystick in enumerate(joysticks):
        ...
        players[i][0][0] = max(player_radius, min(players[i][0][0], window_width - player_radius))
        players[i][0][1] = max(player_radius, min(players[i][0][1], window_height - player_radius))
